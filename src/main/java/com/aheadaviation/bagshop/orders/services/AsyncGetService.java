package com.aheadaviation.bagshop.orders.services;

import com.aheadaviation.bagshop.orders.config.RestProxyTemplate;
...
public class AsyncGetService {
  ...
  @Async
  public <T, B> Future<T> postResource(URI url, B body, ParameterizedTypeReference<T> returnType) {
    RequestEntity<B> request = RequestEntity.post(url).contentType(MediaType.APPLICATION_JSON)
